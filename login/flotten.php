...
?>
<p class="error">
    Es ist eine intergalaktische Störung aufgetreten! Die Sensoren sind beim dem Versuch, einen Anflugspunkt auszumachen, durcheinandergekommen.(<abbr title="Also known as">Aka</abbr> Anfängerschutz.)
</p>
<?php
                                    $noob = true;
                                }
...
?>
<p class="error">
    Es ist eine intergalaktische Störung aufgetreten!<br> Die Sensoren sind beim dem Versuch, einen Anflugspunkt auszumachen, durcheinandergekommen.(<abbr title="Also known as">Aka</abbr> Anfängerschutz.)
</p>
<?php
                                    $noob = true;
                                }
...
?>
        ...
        <dd class="c-auftragsart">Verbandsangriff</dd>
