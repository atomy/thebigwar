...
?>
    ...
    <dd class="c-absender"><a href="help/playerinfo.php?player=<?=htmlentities(urlencode($message->from()))?>&amp;<?=htmlentities(urlencode(session_name()).'='.urlencode(session_id()))?>" title="Informationen zu diesem Spieler anzeigen"><?=utf8_htmlentities($message->from())?></a></dd>
     ...
     <dd class="c-empfaenger"><a href="help/playerinfo.php?player=<?=htmlentities(urlencode($message->to()))?>&amp;<?=htmlentities(urlencode(session_name()).'='.urlencode(session_id()))?>" title="Informationen zu diesem Spieler anzeigen"><?=utf8_htmlentities($message->to())?></a></dd>
...
?>
            <tr class="<?=$class?>">
                ...
                <td class="c-absender"><?=utf8_htmlentities($message->from())?></td>
                           <td class="c-"><?=utf8_htmlentities($message->to())?></td>
