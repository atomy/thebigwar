...
function ths(old_count)
{
	...
	new_count = new_count.join("<?php echo utf8_jsentities(global_setting("THS_UTF8"))?>");
	if(minus)
		new_count = "\u2212"+new_count;
	return new_count;
}
...
function fast_action(node, action_type, galaxy, system, planet)
{
	...
	var request_url = '<?php echo h_root?>/login/scripts/ajax.php?action='+encodeURIComponent(action_type)+'&action_galaxy='+encodeURIComponent(galaxy)+'&action_system='+encodeURIComponent(system)+'&action_planet='+encodeURIComponent(planet)+'&'+encodeURIComponent(session_cookie)+'='+encodeURIComponent(session_id)+'&database='+encodeURIComponent(database_id);
...
{
	if(node.value.length < <?php echo global_setting("LIST_MIN_CHARS")?>)
	{
		if(users_list)
		{
	...
	var xmlhttp = new XMLHttpRequest();
	var request_url = '<?php echo h_root?>/login/scripts/ajax.php?action=userlist&query='+encodeURIComponent(node.value)+'&'+encodeURIComponent(session_cookie)+'='+encodeURIComponent(session_id)+'&database='+encodeURIComponent(database_id);
...
function do_make_alliances_list(node)
{
	...
	var xmlhttp = new XMLHttpRequest();
	var request_url = '<?php echo h_root?>/login/scripts/ajax.php?action=alliancelist&query='+encodeURIComponent(node.value)+'&'+encodeURIComponent(session_cookie)+'='+encodeURIComponent(session_id)+'&database='+encodeURIComponent(database_id);
	xmlhttp.open('GET', request_url, true);
...
function preload_systems(systems)
{
	...
	request_url = '<?php echo h_root?>/login/scripts/ajax.php?action=universe&'+encodeURIComponent(session_cookie)+'='+encodeURIComponent(session_id)+'&database='+encodeURIComponent(database_id);
	var c = 0;
