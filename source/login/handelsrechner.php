...
<form action="handelsrechner.php?<?php echohtmlentities(session_name().'='.urlencode(session_id()))?>" method="post" class="handelsrechner">
	<fieldset class="handelsrechner-handelskurs">
		...
		<dl>
			...
			<dd class="c-carbon"><input type="text" name="handelskurs-carbon" id="handelskurs-carbon" value="<?php echoisset($_POST['handelskurs-carbon']) ? htmlentities($_POST['handelskurs-carbon']) : round($handelskurs[0], 2)?>" onkeyup="calc();" onmouseup="calc();" onchange="calc();" tabindex="24" /></dd>

			<dt class="c-aluminium"><label for="handelskurs-aluminium">Aluminium</label></dt>
			<dd class="c-aluminium"><input type="text" name="handelskurs-aluminium" id="handelskurs-aluminium" value="<?php echoisset($_POST['handelskurs-aluminium']) ? htmlentities($_POST['handelskurs-aluminium']) : round($handelskurs[1], 2)?>" onkeyup="calc();" onmouseup="calc();" onchange="calc();" tabindex="25" /></dd>

			<dt class="c-wolfram"><label for="handelskurs-wolfram">Wolfram</label></dt>
			<dd class="c-wolfram"><input type="text" name="handelskurs-wolfram" id="handelskurs-wolfram" value="<?php echoisset($_POST['handelskurs-wolfram']) ? htmlentities($_POST['handelskurs-wolfram']) : round($handelskurs[2], 2)?>" onkeyup="calc();" onmouseup="calc();" onchange="calc();" tabindex="26" /></dd>

			<dt class="c-radium"><label for="handelskurs-radium">Radium</label></dt>
			<dd class="c-radium"><input type="text" name="handelskurs-radium" id="handelskurs-radium" value="<?php echoisset($_POST['handelskurs-radium']) ? htmlentities($_POST['handelskurs-radium']) : round($handelskurs[3], 2)?>" onkeyup="calc();" onmouseup="calc();" onchange="calc();" tabindex="27" /></dd>

			<dt class="c-tritium"><label for="handelskurs-tritium">Tritium</label></dt>
			<dd class="c-tritium"><input type="text" name="handelskurs-tritium" id="handelskurs-tritium" value="<?php echoisset($_POST['handelskurs-tritium']) ? htmlentities($_POST['handelskurs-tritium']) : round($handelskurs[4], 2)?>" onkeyup="calc();" onmouseup="calc();" onchange="calc();" tabindex="28" /></dd>
		</dl>
...
?>
	<fieldset id="angebot" class="handelsrechner-angebot">
		...
		<dl>
			...
			<dd><input type="text" name="angebot-anteil-carbon" id="angebot-anteil-carbon" size="3" title="Anteil (fortgeschrittener Modus)" class="handelsrechner-anteil" onkeyup="calc();" onmouseup="calc();" onchange="calc();" value="<?php echoisset($_POST['angebot-anteil-carbon']) ? htmlentities($_POST['angebot-anteil-carbon']) : '0'?>" tabindex="3" /> <input type="text" name="angebot-carbon" id="angebot-carbon" value="<?php echohtmlentities($angebot_carbon)?>" onkeyup="calc();" onmouseup="calc();" onchange="calc();" tabindex="4" /></dd>

			<dt><label for="angebot-aluminium">Aluminium</label></dt>
			<dd><input type="text" name="angebot-anteil-aluminium" id="angebot-anteil-aluminium" size="3" title="Anteil (fortgeschrittener Modus)" class="handelsrechner-anteil" onkeyup="calc();" onmouseup="calc();" onchange="calc();" value="<?php echoisset($_POST['angebot-anteil-aluminium']) ? htmlentities($_POST['angebot-anteil-aluminium']) : '0'?>" tabindex="5" /> <input type="text" name="angebot-aluminium" id="angebot-aluminium" value="<?php echohtmlentities($angebot_aluminium)?>" onkeyup="calc();" onmouseup="calc();" onchange="calc();" tabindex="6" /></dd>

			<dt><label for="angebot-wolfram">Wolfram</label></dt>
			<dd><input type="text" name="angebot-anteil-wolfram" id="angebot-anteil-wolfram" size="3" title="Anteil (fortgeschrittener Modus)" class="handelsrechner-anteil" onkeyup="calc();" onmouseup="calc();" onchange="calc();" value="<?php echoisset($_POST['angebot-anteil-wolfram']) ? htmlentities($_POST['angebot-anteil-wolfram']) : '0'?>" tabindex="7" /> <input type="text" name="angebot-wolfram" id="angebot-wolfram" value="<?php echohtmlentities($angebot_wolfram)?>" onkeyup="calc();" onmouseup="calc();" onchange="calc();" tabindex="8" /></dd>

			<dt><label for="angebot-radium">Radium</label></dt>
			<dd><input type="text" name="angebot-anteil-radium" id="angebot-anteil-radium" size="3" title="Anteil (fortgeschrittener Modus)" class="handelsrechner-anteil" onkeyup="calc();" onmouseup="calc();" onchange="calc();" value="<?php echoisset($_POST['angebot-anteil-radium']) ? htmlentities($_POST['angebot-anteil-radium']) : '0'?>" tabindex="9" /> <input type="text" name="angebot-radium" id="angebot-radium" value="<?php echohtmlentities($angebot_radium)?>" onkeyup="calc();" onmouseup="calc();" onchange="calc();" tabindex="10" /></dd>

			<dt><label for="angebot-tritium">Tritium</label></dt>
			<dd><input type="text" name="angebot-anteil-tritium" id="angebot-anteil-tritium" size="3" title="Anteil (fortgeschrittener Modus)" class="handelsrechner-anteil" onkeyup="calc();" onmouseup="calc();" onchange="calc();" value="<?php echoisset($_POST['angebot-anteil-tritium']) ? htmlentities($_POST['angebot-anteil-tritium']) : '0'?>" tabindex="11" /> <input type="text" name="angebot-tritium" id="angebot-tritium" value="<?php echohtmlentities($angebot_tritium)?>" onkeyup="calc();" onmouseup="calc();" onchange="calc();" tabindex="12" /></dd>
		</dl>
	</fieldset>
	<fieldset id="zurueck" class="handelsrechner-erhalten">
		...
		<dl>
			...
			<dd><input type="text" name="zurueck-anteil-carbon" id="zurueck-anteil-carbon" size="3" title="Anteil (fortgeschrittener Modus)" class="handelsrechner-anteil" onkeyup="calc();" onmouseup="calc();" onchange="calc();" value="<?php echoisset($_POST['zurueck-anteil-carbon']) ? htmlentities($_POST['zurueck-anteil-carbon']) : '0'?>" tabindex="13" /> <input type="text" name="zurueck-carbon" id="zurueck-carbon" value="<?php echohtmlentities($zurueck_carbon)?>" onkeyup="calc();" onmouseup="calc();" onchange="calc();" tabindex="14" /></dd>

			<dt><label for="zurueck-aluminium">Aluminium</label></dt>
			<dd><input type="text" name="zurueck-anteil-aluminium" id="zurueck-anteil-aluminium" size="3" title="Anteil (fortgeschrittener Modus)" class="handelsrechner-anteil" onkeyup="calc();" onmouseup="calc();" onchange="calc();" value="<?php echoisset($_POST['zurueck-anteil-aluminium']) ? htmlentities($_POST['zurueck-anteil-aluminium']) : '0'?>" tabindex="15" /> <input type="text" name="zurueck-aluminium" id="zurueck-aluminium" value="<?php echohtmlentities($zurueck_aluminium)?>" onkeyup="calc();" onmouseup="calc();" onchange="calc();" tabindex="16" /></dd>

			<dt><label for="zurueck-wolfram">Wolfram</label></dt>
			<dd><input type="text" name="zurueck-anteil-wolfram" id="zurueck-anteil-wolfram" size="3" title="Anteil (fortgeschrittener Modus)" class="handelsrechner-anteil" onkeyup="calc();" onmouseup="calc();" onchange="calc();" value="<?php echoisset($_POST['zurueck-anteil-wolfram']) ? htmlentities($_POST['zurueck-anteil-wolfram']) : '0'?>" tabindex="17" /> <input type="text" name="zurueck-wolfram" id="zurueck-wolfram" value="<?php echohtmlentities($zurueck_wolfram)?>" onkeyup="calc();" onmouseup="calc();" onchange="calc();" tabindex="18" /></dd>

			<dt><label for="zurueck-radium">Radium</label></dt>
			<dd><input type="text" name="zurueck-anteil-radium" id="zurueck-anteil-radium" size="3" title="Anteil (fortgeschrittener Modus)" class="handelsrechner-anteil" onkeyup="calc();" onmouseup="calc();" onchange="calc();" value="<?php echoisset($_POST['zurueck-anteil-radium']) ? htmlentities($_POST['zurueck-anteil-radium']) : '0'?>" tabindex="19" /> <input type="text" name="zurueck-radium" id="zurueck-radium" value="<?php echohtmlentities($zurueck_radium)?>" onkeyup="calc();" onmouseup="calc();" onchange="calc();" tabindex="20" /></dd>

			<dt><label for="zurueck-tritium">Tritium</label></dt>
			<dd><input type="text" name="zurueck-anteil-tritium" id="zurueck-anteil-tritium" size="3" title="Anteil (fortgeschrittener Modus)" class="handelsrechner-anteil" onkeyup="calc();" onmouseup="calc();" onchange="calc();" value="<?php echoisset($_POST['zurueck-anteil-tritium']) ? htmlentities($_POST['zurueck-anteil-tritium']) : '0'?>" tabindex="21" /> <input type="text" name="zurueck-tritium" id="zurueck-tritium" value="<?php echohtmlentities($zurueck_tritium)?>" onkeyup="calc();" onmouseup="calc();" onchange="calc();" tabindex="22" /></dd>
		</dl>
	</fieldset>
	<noscript>
	...
	<p id="fortgeschrittener-modus" class="handelsrechner-fortgeschrittener-modus">
		<input type="checkbox" name="fortgeschrittener-modus" id="fortgeschrittener-modus-input"<?php echoisset($_POST['fortgeschrittener-modus']) ? ' checked="checked"' : ''?> onchange="refresh_modus();" onclick="refresh_modus();" onkeyup="refresh_modus();" accesskey="u" tabindex="29" /> <label for="fortgeschrittener-modus-input">Fortgeschrittener Mod<kbd>u</kbd>s</label> (<a href="handelsrechner.php?hilfe=0&amp;<?php echohtmlentities(session_name().'='.urlencode(session_id()))?>" onclick="show_hilfe(); return false;">Hilfe</a>)
	</p>
<?php
	if(!isset($_GET['hilfe']))
	{
...
?>
	...
	<div id="hilfe" class="handelsrechner-hilfe">
		<ul id="hilfe-schliessen-klein">
			<li><a href="<?php echohtmlentities($_SERVER['PHP_SELF'])?>?<?php echohtmlentities(session_name().'='.urlencode(session_id()))?>" onclick="hide_hilfe(); return false;"><abbr title="Hilfe schließen">X</abbr></a></li>
		</ul>
		...
		<ul id="beispiele-ausklappen">
			<li><a href="handelsrechner.php?hilfe=<?php echo(isset($_GET['hilfe']) && $_GET['hilfe'] == '1') ? '0' : '1'?>&amp;<?php echohtmlentities(session_name().'='.urlencode(session_id()))?>" onclick="show_beispiel_1(); return false;">Beispiel 1</a></li>
			<li><a href="handelsrechner.php?hilfe=<?php echo(isset($_GET['hilfe']) && $_GET['hilfe'] == '2') ? '0' : '2'?>&amp;<?php echohtmlentities(session_name().'='.urlencode(session_id()))?>" onclick="show_beispiel_2(); return false;">Beispiel 2</a></li>
		</ul>
...
?>
		<div id="beispiel-1" class="handelsrechner-beispiel">
			<h4>Beispiel 1</h4>
			<p>Sie möchten <?php echoths(10000)?>&nbsp;Tritium verscherbeln. Dafür hätten Sie gerne Carbon und Radium. Sie wollen dieses Carbon und dieses Radium im Verhältnis 1:1 ausgezahlt bekommen, das heißt, dass Sie für die eine Hälfte Ihres Tritiums Carbon haben wollen, für die andere aber Radium.</p>
...
?>
		<ul id="hilfe-schliessen">
			<li><a href="<?php echohtmlentities($_SERVER['PHP_SELF'])?>?<?php echohtmlentities(session_name().'='.urlencode(session_id()))?>" onclick="hide_hilfe(); return false;">Hilfe schließen</a></li>
		</ul>
	</div>
<?php
	if(!isset($_GET['hilfe']))
...
<script type="text/javascript">
	...
	{
		document.getElementById('handelskurs-carbon').value = '<?php echoround($handelskurs[0], 2)?>';
		document.getElementById('handelskurs-aluminium').value = '<?php echoround($handelskurs[1], 2)?>';
		document.getElementById('handelskurs-wolfram').value = '<?php echoround($handelskurs[2], 2)?>';
		document.getElementById('handelskurs-radium').value = '<?php echoround($handelskurs[3], 2)?>';
		document.getElementById('handelskurs-tritium').value = '<?php echoround($handelskurs[4], 2)?>';
	}
	...
	<?php echoisset($_GET['hilfe']) ? 'show' : 'hide'?>_hilfe();
	init();
	// ]]>
</script>
