...
<ul>
	<li><?php echo count($items->getItemsList('gebaeude'))?> Gebäude</li>
	<li><?php echo count($items->getItemsList('forschung'))?> Forschungsmöglichkeiten</li>
	<li><?php echo count($items->getItemsList('roboter'))?> verschiedene Roboter</li>
	<li><?php echo count($items->getItemsList('schiffe'))?> Raumschiffklassen</li>
	<li><?php echo count($items->getItemsList('verteidigung'))?> Verteidigungsanlagen</li>
...
<?php
	...
	{
?>
	<li>derzeit <?php echo count($databases)?> verschiedene Runden</li>
<?php
	}
?>
</ul>
