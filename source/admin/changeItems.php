					...
					<tr>
						<td>
							<dl>
								...
								<dt><label for="gebadd-B1">Aluminiumgießerei</label>&nbsp;<dt><span name="B1" id="B1"></span><a href="#" onClick="javascript:add('B1',-10)">-10</a><a href="#" onClick="javascript:add('B1',-1)">-1</a><a href="#" onClick="javascript:add('B1',1)">+1</a><a href="#" onClick="javascript:add('B1',10)">+10</a></dt>
						...
						<td>
							<dl>
								...
								<dt><label for="forsadd-F6">Rückstoßantrieb</label>&nbsp;<dt><span name="f6" id="F6"></span><a href="#" onClick="javascript:add('F6',-10)">-10</a><a href="#" onClick="javascript:add('F6',-1)">-1</a><a href="#" onClick="javascript:add('F6',1)">+1</a><a href="#" onClick="javascript:add('F6',10)">+10</a></dt>
					...
					<tr>
						<td>
							<dl>
								...
								<dt><label for="fleetadd-S1">Großer Transporter</label>&nbsp;<dt><span name="f1" id="S1"></span><a href="#" onClick="javascript:add('S1',-100)">-100</a><a href="#" onClick="javascript:add('S1',-10)">-10</a><a href="#" onClick="javascript:add('S1',-1)">-1</a><a href="#" onClick="javascript:add('S1',1)">+1</a><a href="#" onClick="javascript:add('S1',10)">+10</a><a href="#" onClick="javascript:add('S1',100)">+100</a></dt>
