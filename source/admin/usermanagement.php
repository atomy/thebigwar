...
?>
			<tr>
				<td><input type="text" name="admin_array[<?php=htmlentities($i)?>][0]" value="<?php=utf8_htmlentities($name)?>" readonly /></td>			
<?php
...
<?php
				...
				{
?>
				<td><a href="editAdmin.php?username=<?php=htmlentities(urlencode($name))?>">[bearbeiten]</a></td>
<?php
				}
?>
			</tr>
