...
?>
<form action="<?php=htmlentities($request_uri)?>" method="post">
	<dl>
...
<?php
			...
			{
?>
			<option value="<?php=utf8_htmlentities($id)?>"><?php=utf8_htmlentities($info[1])?></option>
<?php
			}
?>
		</select></dd>
...
<ul>
	<li><a href="http://<?php=htmlspecialchars($_SERVER['HTTP_HOST'].h_root)?>/index.php">Zurück zum Spiel</a></li>
</ul>
...
<?php='<?php=xml version="1.0" encoding="UTF-8"?>'."\n"?>
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="de">
		...
		<link rel="stylesheet" href="<?php=htmlspecialchars(h_root.'/admin/style.css')?>" type="text/css" />
		<script type="text/javascript" src="<?php=htmlspecialchars(h_root.'/login/scripts.js.php')?>"></script>
		<script type="text/javascript" src="<?php=htmlspecialchars(h_root.'/sarissa.js')?>"></script>
		<script type="text/javascript" src="<?php=htmlspecialchars(h_root.'/javascript/jQuery.js')?>"></script>
	</head>
	<body>
		<a name="top"></a>
		...
		?>
		<h1><a href="<?php=htmlentities(h_root.'/admin/index.php')?>"><abbr title="The Big War" xml:lang="en">T-B-W</abbr> &ndash; Adminbereich</a> [&nbsp;<a href="?logout=1">Abmelden nicht vergessen!</a>&nbsp;]</h1>
<?php
		}
