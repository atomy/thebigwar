...
<div class="faq" id="requirements">
	<h3>Was brauche ich, um <abbr title="The Big War" xml:lang="en">T-B-W</abbr> zu spielen?</h3>
...
<div class="faq" id="scores">
	...
	<p>Gebäude-, Forschungs-, Roboter-, Flotten- und Verteidigungspunkte berechnen sich aus den Rohstoffen, die die Gebäude/Forschungen/Robotern/Flotten/Verteidigungsanlagen an Rohstoffen gekostet haben, die Sie besitzen. Pro tausend Rohstoffe bekommen Sie dabei einen Punkt in der entsprechenden Kategorie. Gebäude-, Forschungs- und Roboterpunkte sind hierbei "feste Punkte". D.h. die Punkte können nicht durch Zerstörung der betreffenden Sachen wieder verloren gehen. Verteidgungs- und Flottenpunkte sind keine festen Punkte, da die betreffenden Einheiten zerstört werden können.</p>
	...
	<p>Pro Tausend Punkte, die Ihre Gegner im Kampf gegen Sie verlieren, bekommen Sie einen Kampferfahrungspunkt. Mehr Kampferfahrung schafft Ihnen Vorteile im Kampf.</p>
</div>

<div class="faq" id="noobs">
	<h3>Gibt es einen Anfängerschutz?</h3>
	<p>Ja, den gesamten Spielverlauf durch gilt eine Angriffssperre auf Spieler, die weniger als 5000 Punkte&thinsp;<abbr title="Punkte"></abbr> haben.</p>
</div>
...
<div class="faq" id="umode">
	...
	<p>Man kann erst in den Umod wechseln, wenn sich alle Flotten auf dem Rückweg befinden, bereits erteilte Bau- oder Forschungsaufträge werden in der Zwischenzeit eingefroren und laufen weiter sobald man den Umode wieder verlässt.<p>
...
<div class="faq" id="research">
	...
	<p>Beachten Sie: Die Bauzeit der globalen Forschung ist unabhängig davon, von welchem Planeten man aus sie ausbaut. Eine höhere Ausbaustufe des Planeten, auf dem man die Forschung in Auftrag gibt, verkürzt die Bauzeit nicht mehr als Ausbaustufen von Forschungslaboren auf anderen Planeten.</p>
</div>

<div class="faq" id="robots">
	<h3>Wie funktionieren die Roboter?</h3>
	<p>Die Roboter helfen, Gebäudebauzeiten zu verkürzen und die Rohstoffproduktion zu erhöhen. Der Auswirkungsgrad der Roboter hängt von der aktuellen Stufe der Roboterbautechnik ab. Jede Stufe der Roboterbautechnik erhöht dabei den Auswirkungsgrad Ihrer Bauroboter um einen Vierzigstelprozentpunkt, den Ihrer Minenroboter um einen Zweiunddreissigstelprozentpunkt.</p>
	<p>Beachten Sie, dass nur begrenzt Platz für Roboter auf Ihrem Planeten zur Verfügung steht. Für Bauroboter liegt die Grenze bei der Hälfte der ursprünglichen Felderzahl des Planeten (Ingenieurswissenschaft zeigt also keine Wirkung), für Minenroboter liegt sie zusätzlich bei der aktuellen Ausbaustufe der zugehörigen Mine. Übersteigt die Roboterzahl die Grenze, zeigen überschüssige Roboter keinerlei Wirkung mehr.</p>
</div>

<div class="faq" id="fleet">
	<h3>Wieviele Flotten kann ich gleichzeitig verschicken?</h3>
	<p>Die Anzahl der gleichzeitig koordinierbaren Flotten berechnet sich aus der Entwicklungsstufe Ihres Kontrollwesens und der Anzahl der Werften in Ihrem Imperium. Die Ausbaustufen der vorhandenen Werften sind hierbei unerheblich. Pro Planet gibt es nur jeweils eine Werft. Potenzieren Sie einfach das Produkt der beiden Werte mit 0,7 und runden Sie das Ergebnis ab.</p>
...
<div class="faq" id="distance">
	...
	<p>Entfernungen in <abbr title="The Big War" xml:lang="en">T-B-W</abbr> werden in <em><abbr title="Orbits">Or</abbr></em> angegeben. Ein Orbit bezeichnet dabei die Entfernung zum eigenen Trümmerfeld.</p>
