                    ...
                    fwrite($fo, date('Y-m-d, H:i:s')." arriveAtNextTarget() -- Sammeln Ende. Flotten-ID:  ".$this->getName()."\n");
                        ...
                        case 5: # Spionage
                            ...
                            fwrite($fo, date('Y-m-d, H:i:s')." arriveAtNextTarget() -- CASE SPIONAGE. Besiedelter Planet.\n");
                                ...
                                $message_text = "<h3>Spionagebericht des Planeten \xe2\x80\x9e".utf8_htmlentities($target_galaxy->getPlanetName($target[1], $target[2]))."\xe2\x80\x9c (<a href=\"flotten.php?action_galaxy=".htmlentities(urlencode($target[0]))."&amp;action_system=".htmlentities(urlencode($target[1]))."&amp;action_planet=".htmlentities(urlencode($target[2]))."\" title=\"Koordinaten ins Flottenmen� �bernehmen\">".utf8_htmlentities($next_target_nt)."</a>, Eigent\xc3\xbcmer: ".utf8_htmlentities($target_owner).")</h3>\n";
                                $message_text .= "<div id=\"spionage-planet\">\n";
                                $message_text .= "\t<h4>Planet</h4>\n";
                                $message_text .= "\t<dl class=\"planet_".$target_galaxy->getPlanetClass($target[1], $target[2])."\">\n";
                                $message_text .= "\t\t<dt class=\"c-felder\">Felder</dt>\n";
