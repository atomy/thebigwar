...
<a
	href="ticketsystem.php?<?=htmlentities( session_name() . '=' . urlencode( session_id() ) . '&showMyTickets=1' )?>">Zurück
...
<a href="ticketsystem.php?<?=htmlentities( session_name() . '=' . urlencode( session_id() ) . '&showMyTickets=1' )?>">Zurück
zur Ticketübersicht</a>
<?
    }
